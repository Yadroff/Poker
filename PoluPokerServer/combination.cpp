 ...
 * \param suits - вектор, в i-ом элементе которого содержится количество карт, имеющих i-ую масть
 * \return вектор, содержащий масти флэшей
 */
 ...
 * \param nominals - вектор, в i-й позиции которого количество карт с i-м номиналом
 * \return вектор, содержащий номиналы пар
 */
 ...
 * \param nominals - вектор, в i-й позиции которого количество карт с i-м номиналом
 * \return вектор, содержащий номиналы сетов
 */
 ...
 * \return вектор пар <Nominal, Suit>, определяющих стрит-флэш. Nominal - номинал начало стрит флэша
 */
 ...
 * \param nominals - вектор номиналов. В i-м позиции лежит количество i-х номиналов в руке
 * \return вектор, в котором лежат номиналы каре
 */
QVector<Nominal>
...
//                << " : PAIR NOMINAL: " << (int)maxPairNominal << std::endl;
        }
    }
    return fullHouse;
}
...
Combinations Combination::combination() const {
    return combination_;
}
